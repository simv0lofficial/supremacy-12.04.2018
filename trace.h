...
public:
	__forceinline int GetPointContents( const vec3_t& position, int mask = MASK_ALL ) {
		return util::get_method< int( __thiscall* )( decltype( this ), const vec3_t&, int ) >( this, GETPOINTCONTENTS )( this, position, mask );
	}
